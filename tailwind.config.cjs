...
module.exports = {
	...
	theme: {
		...
		fontFamily: {
			'sans': ['Minecraft AE', ...defaultTheme.fontFamily.sans],
			'minecraft': ['Minecraft AE', ...defaultTheme.fontFamily.sans],
			'minecrafter': ['Minecraft AE', ...defaultTheme.fontFamily.sans],
			'minecrafter-alt': ['Minecraft AE', ...defaultTheme.fontFamily.sans],
			'minecraft-evenings': ['Minecraft AE', ...defaultTheme.fontFamily.sans],
			/* 'mono': ['Minecraft AE', ...defaultTheme.fontFamily.mono],
			'monocraft': ['Minecraft AE', 'Minecraft AE', ...defaultTheme.fontFamily.mono],*/
		},
		extend: {
			colors: {
				//Misc
